        ...
        <div class="rejestracja">
         Rejestracja
                ...
                <form action="rejestracja.php" method="POST">
                    ...
                    <input type="submit" value="Zrejestruj sie">
                </form>
        </div>
        <br><br/>
...
if(empty($_POST["login"]) || empty($_POST["email"]) || empty($_POST["haslo"]) ){
    ...
    if (mysqli_num_rows($wynik)== 0) {
        ...
        ?><script>alert("Brawo zarejestrowales sie! Teraz wystarczy się już tylko zalogować!");</script> <?php
    }

    else{
        ?> <script>alert("Brawo NIE zarejestrowales sie!");</script> <?php
    }
}  
